...
public class chapter8  extends android.app.Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragement_ch8);
        ...
        NextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(chapter8.this, chapter9.class);
        ...
        PreviousButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(chapter8.this, chapter7.class);
                startActivity(intent);
                finish();
            }
        });
