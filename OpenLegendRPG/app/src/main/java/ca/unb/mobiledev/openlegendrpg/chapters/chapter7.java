...
public class chapter7  extends android.app.Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragement_ch7);
        ...
        NextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(chapter7.this, chapter8.class);
        ...
        PreviousButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(chapter7.this, chapter6.class);
                startActivity(intent);
                finish();
            }
        });
